...
<template>
  ...
  >
    ...
    <!-- 骨架屏 -->
    <!-- <div v-if="!isReload" class="msg-list absolute left-0 top-0 z-1 w-full flex flex-col overflow-hidden bg-color-3 transition-(200 opacity)">
      <ChatMsgSkeleton v-for="i in 8" :key="i" />
    </div> -->
  </el-scrollbar>
</template>
