  ...
  <template v-if="setting.isWeb">
    ...
    >
      <template #reference>
        ...
        >
          <svg aria-hidden="true" viewBox="0 0 24 24" version="1.1" data-view-component="true" class="fill-dark dark:fill-light">
